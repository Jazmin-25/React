...
class Productos extends Component{
    productos = [
        ...
        {
            nombre: "Cuaderno Profesional Norma / Raya / 160 hojas", 
            descripcion: "Cuaderno profesional / Cubiertas fragil / Doble espiral metálica / Para uso universitario o profesional",
            precio : 299,
            url_imagen : "producto_3.jpg"
          }
      ];
